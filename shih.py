...
data = (
        ("John", "Johnson", "jj@gmail.com"),
        ("James", "Madison", "jm@jmu.edu"),
        ("Lou", "Anarumo", "louanarumo@gmail.com"),
        ("Zac", "Taylor", "zt@bengals.com"))

df = pd.DataFrame({'First name': [0, 1, 2, 3, 4],
                   'Last name': [5, 6, 7, 8, 9],
                   'Email': ['a', 'b', 'c--', 'd', 'e']})
...
@app.route('/about')
def about():
    full_filename = os.path.join(app.config['UPLOAD_FOLDER'], 'chase.jpg')
    return render_template('about.html', tables=[df.to_html(classes='data')], titles=df.columns.values, user_image=full_filename)
